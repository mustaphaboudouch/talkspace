 ...
 */
final class Version20230226122738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT NOT NULL, description TEXT DEFAULT NULL, experience VARCHAR(255) DEFAULT NULL, duration INT NOT NULL, cleanup INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE appointment (id INT NOT NULL, patient_id INT NOT NULL, doctor_id INT NOT NULL, service_id INT NOT NULL, date DATE NOT NULL, start_time TIME(0) WITHOUT TIME ZONE NOT NULL, end_time TIME(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE schedule (id INT NOT NULL, doctor_id INT NOT NULL, day VARCHAR(9) NOT NULL, start_time TIME(0) WITHOUT TIME ZONE NOT NULL, end_time TIME(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5A3811FB87F4FB17 ON schedule (doctor_id)');
        $this->addSql('CREATE TABLE service (id INT NOT NULL, doctor_id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E19D9AD287F4FB17 ON service (doctor_id)');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, account_id INT DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, is_verified BOOLEAN NOT NULL, profile_picture VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(10) DEFAULT NULL, social_number VARCHAR(15) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
